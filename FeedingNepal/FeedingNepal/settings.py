...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'donor.context_processors.donor_context',
            ],
        },
    },
]
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": "70SA14610@p",  # Ensure the correct password is provided
...
#         "NAME": BASE_DIR
#         / "db.sqlite3",  # This creates a file named db.sqlite3 in your project root
#     }
# }
...
)  # Required for collectstatic command to gather static files
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = (
    False  # Don't expire session on browser close (set to True to expire on close)
)
